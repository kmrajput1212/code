...
public class WebmathPractice {
@Test
public void Practic() throws IOException {
	...
	WebDriver driver= new ChromeDriver();
	 ...
	 props.load (reader);
	  ...
	  K8.click();
	  WebElement Practic = driver.findElement(By.xpath(props.getProperty("Practic")));
	  Practic.click();
	  WebElement go = driver.findElement(By.xpath(props.getProperty("go")));
	  go.click();
}
}
