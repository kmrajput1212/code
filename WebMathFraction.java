...
public void Fraction () throws IOException {
	...
	WebDriver driver= new ChromeDriver();
	 ...
	 props.load (reader);
	  ...
	  K8.click();
	  WebElement fraction = driver.findElement(By.xpath(props.getProperty("Fraction")));
	  fraction.click();
	  WebElement name1 = driver.findElement(By.xpath(props.getProperty("name1")));
	  name1.sendKeys("5");
	  WebElement name2= driver.findElement(By.xpath(props.getProperty("name2")));
	  name2.sendKeys("25");
	  WebElement button = driver.findElement(By.xpath(props.getProperty("button2")));
	  button.click();
