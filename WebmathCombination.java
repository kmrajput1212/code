...
public class WebmathCombination {
@Test
public void Combination() throws IOException {
	...
	WebDriver driver= new ChromeDriver();
	 ...
	 props.load (reader);
	  ...
	  K8.click();
	  WebElement combination= driver.findElement(By.xpath(props.getProperty("combination")));
	  combination.click();
	  WebElement items= driver.findElement(By.xpath(props.getProperty("items")));
	  items.sendKeys("25");
	  WebElement showme= driver.findElement(By.xpath(props.getProperty("showme")));
	  showme.click();
