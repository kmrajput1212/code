...
public void time () throws IOException {
	...
	WebDriver driver= new ChromeDriver();
	 ...
	 props.load (reader);
	  ...
	  K8.click();
	  WebElement time = driver.findElement(By.xpath(props.getProperty("time")));
	  time.click();
	  WebElement Name = driver.findElement(By.xpath(props.getProperty("Name2")));
	  Name.sendKeys("5");
	  WebElement Button = driver.findElement(By.xpath(props.getProperty("Button3")));
	  Button.click();
}
}
