...
public void round() throws IOException {
	...
	WebDriver driver= new ChromeDriver();
	 ...
	 props.load (reader);
	  ...
	  K8.click();
	  WebElement round= driver.findElement(By.xpath(props.getProperty("Rounding")));
	  round.click();
	  WebElement number1 = driver.findElement(By.xpath(props.getProperty("number1")));
	  number1.sendKeys("125");
	  WebElement Roundit= driver.findElement(By.xpath(props.getProperty("Roundit")));
	  Roundit.click();
}
}
