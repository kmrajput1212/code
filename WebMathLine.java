...
public void Line() throws IOException {
	...
	WebDriver driver= new ChromeDriver();
	 ...
	 props.load (reader);
	  ...
	  K8.click();
	  WebElement Line = driver.findElement(By.xpath(props.getProperty("Line")));
	  Line.click();
	  WebElement name1 = driver.findElement(By.xpath(props.getProperty("name")));
	  name1.sendKeys("25");
	  WebElement name2 = driver.findElement(By.xpath(props.getProperty("name2")));
	  name2.sendKeys("8");
	  WebElement show = driver.findElement(By.xpath(props.getProperty("Show")));
	  show.click();
